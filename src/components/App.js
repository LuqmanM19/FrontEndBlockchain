...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    console.log(web3)
    // Load account
    // console.log(weth.givenProvider)
    ...
    if(networkData) {
      ...
      const threshold = await this.state.bank.methods.threshold().call()
      console.log(threshold)

      // num = await this.state.bank.methods.upper_threshold().call()
      // const upperThreshold = num.toString()
      const upperThreshold = await this.state.bank.methods.upper_threshold().call()
